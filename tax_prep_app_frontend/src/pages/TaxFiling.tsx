...
export default function TaxFiling() {
    ...
    return (
        <>
          ...
          {currentPage == 5 && (<W2Form isTaxFiling={true} handleSubmit={handleW2FormSubmit} handleCancel={handleFormCancel}/>)}
          {currentPage == 6 && (<Form1099 isTaxFiling={true} handleSubmit={handle1099FormSubmit} handleCancel={handleFormCancel}/>)}
